(() => {
  ...
  const TOP_STORY_URL = "https://www.techradar.com/pro/dell-27-plus-qhd-usb-c-s2725dc-business-monitor-review";
  ...
  refreshFeed.addEventListener("click", () => refreshLatest({forcePageRefresh: true}));
