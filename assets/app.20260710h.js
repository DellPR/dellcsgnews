(() => {
  ...
  function explicitDealText(item) {
    ...
    const directCommerce = [
      ...
      /\bnotebooks? em oferta\b|\bnotebooks? baratos\b/i,
    ];
    ...
    // "deal" and "sales" often mean business transactions or shipment data.
    // Only treat them as Deals when they have a shopping modifier.
